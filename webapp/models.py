...
class Permalink(db.Model):
    ...
    phrase = db.StringProperty(required=True)
    @permalink
    def get_absolute_url(self):
        return ('webapp.views.show_phrase', (), {'key': self.key()})    
...
#     @permalink
#     def get_absolute_url(self):
#         return ('webapp.views.show_person', (), {'key': self.key()})
# 
...
#     @permalink
#     def get_absolute_url(self):
#         return ('webapp.views.download_file', (), {'key': self.key(),
#                                                   'name': self.name})
# 
#     def __unicode__(self):
